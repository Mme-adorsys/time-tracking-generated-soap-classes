/**
 * ReadRechnungLexwareRequestType.java
 * <p>
 ...
 */
public class ReadRechnungLexwareRequestType implements java.io.Serializable {
    // Type metadata
    private static org.apache.axis.description.TypeDesc typeDesc =
            new org.apache.axis.description.TypeDesc(ReadRechnungLexwareRequestType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://zep.provantis.de", "ReadRechnungLexwareRequestType"));
    ...
    public ReadRechnungLexwareRequestType() {
    }
    ...
    /**
     * Gets the requestHeader value for this ReadRechnungLexwareRequestType.
     *
    ...
    /**
     * Sets the requestHeader value for this ReadRechnungLexwareRequestType.
     *
    ...
    /**
     * Gets the readRechnungSearchCriteria value for this ReadRechnungLexwareRequestType.
     *
    ...
    /**
     * Sets the readRechnungSearchCriteria value for this ReadRechnungLexwareRequestType.
     *
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof ReadRechnungLexwareRequestType)) return false;
        ReadRechnungLexwareRequestType other = (ReadRechnungLexwareRequestType) obj;
