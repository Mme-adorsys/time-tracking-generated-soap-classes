/**
 * ReadKostenLexwareRequestType.java
 * <p>
 ...
 */
public class ReadKostenLexwareRequestType implements java.io.Serializable {
    // Type metadata
    private static org.apache.axis.description.TypeDesc typeDesc =
            new org.apache.axis.description.TypeDesc(ReadKostenLexwareRequestType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://zep.provantis.de", "ReadKostenLexwareRequestType"));
    ...
    /* Die Suchkriterien für die Suche nach Buchungen im Lexware Format. */
    private ReadKostenSearchCriteriaType readKostenSearchCriteria;
    private Object __equalsCalc = null;
    private boolean __hashCodeCalc = false;


    public ReadKostenLexwareRequestType() {
    }
    ...
    /**
     * Gets the requestHeader value for this ReadKostenLexwareRequestType.
     *
    ...
    /**
     * Sets the requestHeader value for this ReadKostenLexwareRequestType.
     *
    ...
    /**
     * Gets the readKostenSearchCriteria value for this ReadKostenLexwareRequestType.
     *
     * @return readKostenSearchCriteria   * Die Suchkriterien für die Suche nach Buchungen im Lexware Format.
     */
    ...
    /**
     * Sets the readKostenSearchCriteria value for this ReadKostenLexwareRequestType.
     *
     * @param readKostenSearchCriteria   * Die Suchkriterien für die Suche nach Buchungen im Lexware Format.
     */
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof ReadKostenLexwareRequestType)) return false;
        ReadKostenLexwareRequestType other = (ReadKostenLexwareRequestType) obj;
