...
public class MonatlichType implements java.io.Serializable {
    // Type metadata
    private static org.apache.axis.description.TypeDesc typeDesc =
            new org.apache.axis.description.TypeDesc(MonatlichType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://zep.provantis.de", "MonatlichType"));
        ...
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("alleBestimmteMonate");
        elemField.setXmlName(new javax.xml.namespace.QName("", "alleBestimmteMonate"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
     ...
     * (nicht beide). */
    private String bis;
    private Integer alleBestimmteMonate;
    /* 1,...,28(,29,30,31) */
    ...
    public MonatlichType(
            Integer endetNach,
            String bis,
            Integer alleBestimmteMonate,
            Integer monatstag,
            Integer wochentag,
            Integer monatswoche) {
        this.endetNach = endetNach;
        this.bis = bis;
        this.alleBestimmteMonate = alleBestimmteMonate;
    ...
    /**
     * Gets the endetNach value for this MonatlichType.
     *
    ...
    /**
     * Sets the endetNach value for this MonatlichType.
     *
    ...
    /**
     * Gets the bis value for this MonatlichType.
     *
    ...
    /**
     * Sets the bis value for this MonatlichType.
     *
    ...
    /**
     * Gets the alleBestimmteMonate value for this MonatlichType.
     *
     * @return alleBestimmteMonate
     */
    public Integer getAlleBestimmteMonate() {
        return alleBestimmteMonate;
    }

    /**
     * Sets the alleBestimmteMonate value for this MonatlichType.
     *
     * @param alleBestimmteMonate
     */
    public void setAlleBestimmteMonate(Integer alleBestimmteMonate) {
        this.alleBestimmteMonate = alleBestimmteMonate;
    }

    /**
     * Gets the monatstag value for this MonatlichType.
     *
    ...
    /**
     * Sets the monatstag value for this MonatlichType.
     *
    ...
    /**
     * Gets the wochentag value for this MonatlichType.
     *
    ...
    /**
     * Sets the wochentag value for this MonatlichType.
     *
    ...
    /**
     * Gets the monatswoche value for this MonatlichType.
     *
    ...
    /**
     * Sets the monatswoche value for this MonatlichType.
     *
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof MonatlichType)) return false;
        MonatlichType other = (MonatlichType) obj;
        ...
        _equals = true &&
                ...
                ((this.alleBestimmteMonate == null && other.getAlleBestimmteMonate() == null) ||
                        (this.alleBestimmteMonate != null &&
                                this.alleBestimmteMonate.equals(other.getAlleBestimmteMonate()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getAlleBestimmteMonate() != null) {
            _hashCode += getAlleBestimmteMonate().hashCode();
        }
