/**
 * ReadRechnungGenericRequestType.java
 * <p>
 ...
 */
public class ReadRechnungGenericRequestType implements java.io.Serializable {
    // Type metadata
    private static org.apache.axis.description.TypeDesc typeDesc =
            new org.apache.axis.description.TypeDesc(ReadRechnungGenericRequestType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://zep.provantis.de", "ReadRechnungGenericRequestType"));
    ...
    public ReadRechnungGenericRequestType() {
    }
    ...
    /**
     * Gets the requestHeader value for this ReadRechnungGenericRequestType.
     *
    ...
    /**
     * Sets the requestHeader value for this ReadRechnungGenericRequestType.
     *
    ...
    /**
     * Gets the readRechnungSearchCriteria value for this ReadRechnungGenericRequestType.
     *
    ...
    /**
     * Sets the readRechnungSearchCriteria value for this ReadRechnungGenericRequestType.
     *
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof ReadRechnungGenericRequestType)) return false;
        ReadRechnungGenericRequestType other = (ReadRechnungGenericRequestType) obj;
