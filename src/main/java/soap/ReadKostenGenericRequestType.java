/**
 * ReadKostenGenericRequestType.java
 * <p>
 ...
 */
public class ReadKostenGenericRequestType implements java.io.Serializable {
    // Type metadata
    private static org.apache.axis.description.TypeDesc typeDesc =
            new org.apache.axis.description.TypeDesc(ReadKostenGenericRequestType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://zep.provantis.de", "ReadKostenGenericRequestType"));
    ...
    /* Die Suchkriterien für die Suche nach Buchungen im generischen
     * Format. */
    ...
    public ReadKostenGenericRequestType() {
    }
    ...
    /**
     * Gets the requestHeader value for this ReadKostenGenericRequestType.
     *
    ...
    /**
     * Sets the requestHeader value for this ReadKostenGenericRequestType.
     *
    ...
    /**
     * Gets the readKostenSearchCriteria value for this ReadKostenGenericRequestType.
     *
     * @return readKostenSearchCriteria   * Die Suchkriterien für die Suche nach Buchungen im generischen
     * Format.
     */
    ...
    /**
     * Sets the readKostenSearchCriteria value for this ReadKostenGenericRequestType.
     *
     * @param readKostenSearchCriteria   * Die Suchkriterien für die Suche nach Buchungen im generischen
     * Format.
     */
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof ReadKostenGenericRequestType)) return false;
        ReadKostenGenericRequestType other = (ReadKostenGenericRequestType) obj;
